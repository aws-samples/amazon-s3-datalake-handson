...
Redshift は利用可能になるまで時間がかかるので、最初に作業を行います。この手順では、Redshift クラスターを作成します。
 ...
 3. **[サブネットグループ]** をクリックし、 **[クラスターサブネットグループの作成]** をクリックします。

 4. 以下の値を入力し、**[クラスターサブネットグループの作成]** をクリックします。
...
Redshift にデータをロードします。
 ...
 8. **[変更中]** が消えたら、左ペインから **[エディタ]** を選択し、 Redshift に接続し、先にロード対象のテーブルを作成します。以下のクエリを入力し、 **[実行]** をクリックし、クエリを実行します。
...
#### これまでの手順で、1~11を実施している場合はスキップ
 ...
 9. **[Amazon S3]** の **[詳細]** をクリックし、 **[S3 バケットを選択する]** をクリックします。
  ...
  <img src="images/Lab5-Section4-Step4-9.png">

...
### Step1：CloudWatch Logs の設定
 ...
 1. AWS マネジメントコンソールのサービス一覧から **CloudWatch** を選択し、 **[CloudWatch]** の画面の左側ペインから **[ログ]** をクリックします。  
...
### Step3：CloudWatch アラームの設定
 ...
 1. AWS マネジメントコンソールのサービス一覧から **CloudWatch** を選択し、**[ログ]** をクリックし、「 **minilake_group** （任意）」のロググループにチェックを入れ、 **[メトリクスフィルタの作成]** をクリックします。

...
2. You check [existing open](https://github.com/awsdocs/amazon-s3-datalake-handson/pulls), and [recently closed](https://github.com/awsdocs/amazon-s3-datalake-handson/pulls?q=is%3Apr+is%3Aclosed), pull requests to be sure that someone else hasn't already addressed the problem.
3. You [create an issue](https://github.com/awsdocs/amazon-s3-datalake-handson/issues/new) before working on a contribution that will take a significant amount of your time.
...
See the [LICENSE](https://github.com/awsdocs/amazon-s3-datalake-handson/blob/master/LICENSE) file for this project's licensing. We will ask you to confirm the licensing of your contribution. We may ask you to sign a [Contributor License Agreement (CLA)](http://en.wikipedia.org/wiki/Contributor_License_Agreement) for larger changes.
